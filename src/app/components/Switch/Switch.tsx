    ...
    return (
        <>
            <label className="inline-flex items-center cursor-pointer">
                ...
                />
                <div className="relative w-11 h-6 bg-pink-400 peer-focus:outline-none  rounded-full peer dark:bg-white-700 peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full  after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:rounded-full after:h-5 after:w-5 after:transition-all  peer-checked:!bg-pink-400 p-1" />
